...
class ProductCategory(models.Model):
    ...
    photo = models.ImageField(upload_to='categories_images', null=True, blank=True)
...
class Product(models.Model):
    ...
    description = models.TextField(max_length=1024, default='Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod kon tempor incididunt ut labore.')
