...
class UserRegistrationViewTestCase(TestCase):
    ...
    def setUp(self):
        self.data = {
            'first_name': 'Petr', 'last_name': 'Kavchenko',
            'username': 'petr', 'email': 'petr_kavchenko@mail.ru',
            'password1': 'hjkfb38fbd', 'password2': 'hjkfb38fbd',
        }
        self.path = reverse('app_users:registration')
